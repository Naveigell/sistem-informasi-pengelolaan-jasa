            ...
            <transition-group name="insert-transition">
                <div key="modal" class="insert-container" v-if="inAnimation">
                    ...
                    <form @submit.prevent>
                        ...
                        <span class="sub-title">Isi form dibawah untuk menambah teknisi baru</span> <br/>
                        <div class="input-container">
                            <label for="">Nama</label>
                            <input v-bind:class="{'input-error': errors.name != null && errors.name !== undefined}" @focus="errors.name = null;" type="text" placeholder="Nama Teknisi" v-model="data.name">
                            <span class="error-message" v-if="errors.name != null && errors.name !== undefined">{{ errors.name[0] }}</span>
                        </div>
                        <div class="input-container">
                            <label for="">Username</label>
                            <input v-bind:class="{'input-error': errors.username != null && errors.username !== undefined}" @focus="errors.username = null;" type="text" placeholder="Username Teknisi" v-model="data.username">
                        ...
                        <div class="input-container">
                            ...
                            <input v-bind:class="{'input-error': errors.email != null && errors.email !== undefined}" @focus="errors.email = null;" type="text" placeholder="Email Teknisi" v-model="data.email">
